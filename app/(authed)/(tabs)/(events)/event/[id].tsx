...
const EventDetailScreen = () => {
  ...
  return (
    <VStack m={20} flex={1} gap={30}>
      <VStack gap={5}>
        <Text ml={5} fontSize={14} color="gray">
          Name
        </Text>
        <Input
          value={eventData?.title}
          onChangeText={(value) => updateFields("title", value)}
          placeholder="Name"
      ...
      <VStack gap={5}>
        ...
        <Input
          ...
          onChangeText={(value) => updateFields("location", value)}
          placeholder="Name"
          placeholderTextColor="darkgray"
          p={14}
        />
      ...
      <VStack gap={5}>
        ...
        <DateTimePicker
          onChange={(date) => updateFields("date", date || new Date())}
